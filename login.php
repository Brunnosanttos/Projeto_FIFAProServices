    ...
    <div class="main">
      ...
      <div class="login">
        <form class="form-login" action="config/testLogin.php" method="POST">
          ...
          <div class="senha-visivel-login">
            <input type="checkbox" onclick="togglePassword('login-password')" id="toggle-password"> Mostrar senha
          </div>
      ...
      <div class="register">
        <form class="form-register" action="config/testCadastro.php" method="POST">
          ...
          <input class="input-register" id="register-password" type="password" name="pswd" placeholder="Senha" required>
          <div class="senha-visivel-register">
            <input type="checkbox" onclick="togglePassword('register-password')" id="toggle-password"> Mostrar senha
          </div>
